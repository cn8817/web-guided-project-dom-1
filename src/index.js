...
const links = header.querySelectorAll('nav a') //creates a node list
console.log(links)
...
//const aboutNavItem = linksRealArray.find(link => link.textContent === 'About') //find finds the first thing that fits the criterior while filter finds all 
...
// bracket notation logoTitle['textContent']
titleFirstCard.textContent = 'I rulez'
subtitleFirstCard.textContent = 'obviously'
textFirstCard.textContent = 'dog ipdum'
link2FirstCard.textContent = 'doggy'
